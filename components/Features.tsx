...
import { details, features } from "@/constants/constant";
    ...
    <section className=' overflow-hidden'>
      <div >
        <div className="container">
          <div className="relative flex md:flex-wrap flex-nowrap border-2 border-s3 rounded-7xl overflow-hidden max-md:flex-col feature-after md:g7 max-md:border-none max-md:rounded-none max-md:gap-3">
            {features.map(({ id, icon, caption, title, text, button }) => (
              ...
              >
                ...
                <p className="mb-11 text-[#c3caf4] body-1 max-md:mb-8 max-md:body-3">{text}</p>
            ...
            <ul className="relative flex justify-around flex-grow px-[5%] border-2 border-s3 rounded-7xl max-md:hidden">
              ...
              {details.map(({ id, icon, title }) => (
                <li key={id} className="relative pt-16 px-4 pb-14">
                  ...
                  <h3 className="relative z-2 max-w-36 mx-auto my-0 base-small text-center uppercase text-[#c3caf4]">
                    {title}
                  </h3>
                </li>
              ))}
