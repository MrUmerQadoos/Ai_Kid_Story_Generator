export const features = [
  {
    ...
    text: "With Ai Kid Story, tedious tasks are history. Automation and smart processes bring your productivity to new heights. It's like having an extra cup of coffee, but without the jitters.",
    button: {
  ...
  },
  {
    ...
    text: "Your data security is our priority. With state-of-the-art encryption and robust privacy controls, Ai Kid Story helps keeps your information secure and locked up tighter than Fort Knox.",
    button: {
...
export const faq = [
  {
    id: "0",
    question: "How easy is it to setup Ai Kid Story?",
    answer:
      "Absolutely! Not only you can upgrade your plan at any time but you also get a prorated discount giving you maximum value for your subscription.",
  },
  {
    id: "1",
    question: "Can I integrate Ai Kid Story with other platforms?",
    answer:
      "Absolutely! Not only you can upgrade your plan at any time but you also get a prorated discount giving you maximum value for your subscription.",
  },
  {
...
export const plans = [
  {
    ...
    priceMonthly: 0, // Free
    priceYearly: 0, // Free
    caption: "Access to test the platform",
    credits: 100, // One-time credits for trial
    features: [
      "100 Credits (One-time)",
      "Access to generate stories and images",
      "Basic support",
 ...
 logo: "/images/plan-1.png",
  },
  {
    id: "1",
    title: "Most Popular",
    priceMonthly: 39, // $39 per month
    priceYearly: 360, // $360 per year ($30/month - discounted)
    caption: "Best plan for regular users",
    credits: 1000, // 1,000 credits per month or 12,000 per year
    features: [
  ...
  },
  {
    id: "2",
    title: "Premium",
    priceMonthly: 79, // $79 per month
    priceYearly: 720, // $720 per year ($60/month - discounted)
    caption: "Best plan for premium users  ",
    credits: 5000, // 5,000 credits per month or 60,000 per year
    features: [
...
export const testimonials = [
  {
    ...
    comment:
      "Ai Kid Story's customer support is second to none! They’re like my tech superheroes, always there when I need them.",
  },
  {
    id: "1",
    name: "Mark Erixon",
  ...
  },
  {
    ...
    comment:
      "Switched to Ai Kid Story last month, and I'm already seeing results. Best decision for our team!",
  },
  {
    id: "5",
    name: "Jim Bradley",
